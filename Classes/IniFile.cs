 ...
 */
    ...
    public class IniFile
    {
        ...
        private string section = Path.GetFileNameWithoutExtension(AppDomain.CurrentDomain.BaseDirectory.ToString());
        ...
        public IniFile(string fileName)
        {
            ...
            {
                String strAppDir = AppDomain.CurrentDomain.BaseDirectory.ToString(); 
